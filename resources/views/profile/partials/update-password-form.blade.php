<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Stelle sicher, dass dein Konto ein langes, zufälliges Passwort verwendet.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Aktuelles Password')" />
