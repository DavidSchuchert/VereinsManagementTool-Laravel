...
">Aktueller Stand:
    ...
    <p>Transaktionsanzahl: <b>{{ $zahlungen->count() }}</b>
        ...
        <a href="{{ route('zahlungen.exportPdf', request()->query()) }}" class="btn btn-primary export_btn">🖨️Exportieren als
            PDF</a>
                            ...
                            <td colspan="2" class="transactions_td">
                                ...
                                <div class="extra_info">
                                    ...
                                    <form action="{{ route('zahlungen.destroy', $zahlung->id) }}" method="POST"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <img src="{{ asset('images/delete-svgrepo-com.svg') }}" alt="löschen"
                                            class="icon">
